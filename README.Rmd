...
We demonstrate the graphical capabilities of `ERPplot` with these real data set `DirectedForgetting`. Download data `DirectedForgetting` from [website](https://goo.gl/NsB5pX) or directly use the build-in one.
...
```{r F06p,message=FALSE, fig.height=10}
grid.arrange(Fig06a +
                     ggtitle("A") +
